        ...
        <div class="panel-body">
            <div class="row">
                    <div class="col-md-12">
                        ...
                        <p>Fondos actuales: $<?php echo $saldo; ?>. <br>Puedes retirar como m&iacute;nimo $1000 y como m&aacute;ximo $<?php echo $saldo; ?>.</p>
                        <div role="form">
                            <div class="form-group col-md-6">
                                <label>Monto a Retirar</label>
                                <input id="retirar1" class="form-control" />
                            </div>
                            ...
                            <div class="botones">
                                ...
                                <button onclick="submitretirar()" class="btn btn-primary">Retirar</button>
                            </div>
                        </div>
                    </div>
                </div>
